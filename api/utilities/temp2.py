...
args = dict({'shape_predictor': 'shape_predictor_68_face_landmarks.dat'})
...
# predictor = dlib.shape_predictor('shape_predictor_68_face_landmarks.dat')  # finds eye position
predictor = dlib.shape_predictor(args['shape_predictor'])  # finds eye position
